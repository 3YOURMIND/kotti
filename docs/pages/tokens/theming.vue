...
<KtSelect :allowEmpty="true" label="Navbar Border Color" v-model="navbarBorderColor" :options="colors" />
<KtSelect :allowEmpty="true" label="Navbar Color Active" v-model="navbarColorActive" :options="colors" />

<KtTheme :customProperties="{'navbar-background': navbarBackground, 'navbar-color': navbarColor, 'navbar-color-light': navbarLightColor, 'navbar-border': navbarBorderColor, 'navbar-color-active': navbarColorActive}"/>
