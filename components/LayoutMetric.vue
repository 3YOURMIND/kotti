<template>
  ...
  <h2>Metric</h2>
    <div>
      <p>Our metric based on
        <code>4px</code> and we call it is one unit. The unit can be used as variable in
    ...
    <div>
      <p>Most of the elements in Youi has fixed height, which is
        <code>32px</code>. We suggest element's height should match the metric unit.</p>
    </div>
  </div>
</template>
