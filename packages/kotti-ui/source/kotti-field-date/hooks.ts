...
// export type ElDateWithInternalAPI = Omit<ElDate, '$el'> & {
// 	blur(): void
// 	$el: HTMLElement
// 	parentElement: HTMLElement
// 	haveTrigger: boolean
// 	picker: Omit<ComponentInstance<Component<unknown>>, '$el'> & {
// 		$el: HTMLElement
// 		leftLabel?: string
// 		rightLabel?: string
// 		width: number
...
// 			$root: dateComponent.$root,
// 			haveTrigger: dateComponent.haveTrigger,
// 			picker: dateComponent.picker,
// 			popperJS: dateComponent.popperJS,
// 			pickerVisible: dateComponent.pickerVisible,
// 			referenceElm: dateComponent.referenceElm,
// 			showClose: dateComponent.showClose,
// 		})
...
// 		console.log('before', dateComponent.referenceElm)

// 		dateComponent.referenceElm = ktFieldDateInputContainer

// 		console.log('after', dateComponent.referenceElm)
// 	})
// }
...
// 	popperWidth,
// 	debug = true,
// }: HookParameters<DATA_TYPE> & { debug?: boolean }): void => {
